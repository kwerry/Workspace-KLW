# com-chilipeppr-workspace-KLW
A ChiliPeppr Workspace KLW.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / KLW
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-KLW |
| Name                  | Workspace / KLW |
| Description           | A ChiliPeppr Workspace KLW. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/kwerry/Workspace-KLW/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/kwerry/klw_chilipeppr |
| Github URL            | http://github.com/kwerry/Workspace-KLW |
| Test URL              | https://preview.c9users.io/kwerry/klw_chilipeppr/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/kwerry/Workspace-KLW/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-KLW"], // the id you gave your workspace
      function(myWorkspaceKLW) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / KLW just got loaded.", myWorkspaceKLW);
        myWorkspaceKLW.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-KLW"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / KLW"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace KLW."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/kwerry/Workspace-KLW/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/kwerry/klw_chilipeppr"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/kwerry/Workspace-KLW"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://klw_chilipeppr-kwerry.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
