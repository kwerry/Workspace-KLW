...
cprequire_test(["inline:com-chilipeppr-Workspace-KLW"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-KLW", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-KLW", // Make the id the same as the cpdefine id
        name: "Workspace / KLW", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace KLW.`,
